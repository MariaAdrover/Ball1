 ...
 * @author miaad
 */
public class Ball1 extends JFrame implements Runnable, ActionListener {
    ...
    public Ball1() {
        super("Ball1 - MOVIMIENTO RECTILINEO");
        ...
        this.setGridConstraints(0, 0, 1, 9, 1, 1, 1, 0);
        ...
        this.setGridConstraints(1, 0, 1, 1, 0, 1 / 9, 1, 0);
        contenedor.add(b1, grid);

        this.b2 = new JButton("Movimiento Rectilíneo (Horizontal) Uniformemente Acelerado");
        this.b2.setFont(new Font("Courier New", Font.BOLD, 20));
        this.b2.addActionListener(this);
        this.setGridConstraints(1, 1, 1, 1, 0, 1 / 9, 1, 0);
        ...
        this.setGridConstraints(1, 2, 1, 1, 0, 1 / 9, 1, 0);
        ...
        this.setGridConstraints(1, 3, 1, 1, 0, 1 / 9, 1, 0);
        ...
        this.setGridConstraints(1, 4, 1, 1, 0, 1 / 9, 1, 0);
        contenedor.add(labelY, grid);

        this.labelV = new JLabel("v --> " + this.tablero.getPelota().getV());
        this.labelV.setFont(new Font("Courier New", Font.BOLD, 22));
        this.setGridConstraints(1, 5, 1, 1, 0, 1 / 9, 1, 0);
        contenedor.add(labelV, grid);

        this.labelA = new JLabel("a --> " + this.tablero.getPelota().getA());
        this.labelA.setFont(new Font("Courier New", Font.BOLD, 22));
        this.setGridConstraints(1, 6, 1, 1, 0, 1 / 9, 1, 0);
        contenedor.add(labelA, grid);

        this.b4 = new JButton("RESET");
        this.b4.setFont(new Font("Courier New", Font.BOLD, 20));
        this.b4.addActionListener(this);
        this.setGridConstraints(1, 7, 1, 1, 0, 1 / 9, 1, 0);
        ...
        this.setGridConstraints(1, 8, 1, 1, 0, 1 / 9, 1, 0);
    ...
    private void leerVelocidad() {
        this.labelV.setText("v --> " + this.tablero.getPelota().getV());
    }
